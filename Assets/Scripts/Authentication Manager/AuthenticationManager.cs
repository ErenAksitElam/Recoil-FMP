...
public class AuthenticationManager : MonoBehaviour
{
    ...
    private void RegisterEvents()
    {
        ...
        signInWithUnityButton.onClick.AddListener(OnClickSignInWithUnity);
    ...
    private void DeregisterEvents()
    {
        ...
        signInWithUnityButton.onClick.RemoveListener(OnClickSignInWithUnity);
    ...
    private async void OnClickSignInWithUnity()
    {
        ...
        PlayerPrefs.SetString("PlayerAccessToken", AuthenticationService.Instance.AccessToken);
    ...
    private void UpdateUI()
    {
        ...
        signInWithUnityButton.interactable = !authSignedIn;
